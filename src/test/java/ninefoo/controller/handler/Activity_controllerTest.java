...
public class Activity_controllerTest {
    ...
    public void testCreateActivity_A_0() throws Exception {
        Activity activityA = new Activity("A", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZZZ_0() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZZZ", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_AB_0() throws Exception {
        Activity activityA = new Activity("AB", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZY_0() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZY", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT_0() throws Exception {
        Activity activityA = new Activity("PROJECT", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_0_0() throws Exception {
        Activity activityA = new Activity("0", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_1234567890123456789012345_0() throws Exception {
        Activity activityA = new Activity("1234567890123456789012345", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_01_0() throws Exception {
        Activity activityA = new Activity("01", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_123456789012345678901234_0() throws Exception {
        Activity activityA = new Activity("123456789012345678901234", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_125845_0() throws Exception {
        Activity activityA = new Activity("125845", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT125845_0() throws Exception {
        Activity activityA = new Activity("PROJECT125845", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_A_1000000000() throws Exception {
        Activity activityA = new Activity("A", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZZZ_1000000000() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZZZ", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_AB_1000000000() throws Exception {
        Activity activityA = new Activity("AB", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZZY_1000000000() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZZY", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT_1000000000() throws Exception {
        Activity activityA = new Activity("PROJECT", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_125845_1000000000() throws Exception {
        Activity activityA = new Activity("125845", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT125845_1000000000() throws Exception {
        Activity activityA = new Activity("PROJECT125845", "description", 2, 2, 2, 2, 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT_1() throws Exception {
        Activity activityA = new Activity("PROJECT", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_125845_1() throws Exception {
        Activity activityA = new Activity("125845", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT125845_1() throws Exception {
        Activity activityA = new Activity("PROJECT125845", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT_999999999() throws Exception {
        Activity activityA = new Activity("PROJECT", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_125845_999999999() throws Exception {
        Activity activityA = new Activity("125845", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_PROJECT125845_999999999() throws Exception {
        Activity activityA = new Activity("PROJECT125845", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_AB_1() throws Exception {
        Activity activityA = new Activity("AB", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_12_1() throws Exception {
        Activity activityA = new Activity("12", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZY_999999999() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZY", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_123456789012345678901234_999999999() throws Exception {
        Activity activityA = new Activity("123456789012345678901234", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_AB_999999999() throws Exception {
        Activity activityA = new Activity("AB", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_12_999999999() throws Exception {
        Activity activityA = new Activity("12", "description", 2, 2, 2, 2, 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_ZZZZZZZZZZZZZZZZZZZZZZZY_1() throws Exception {
        Activity activityA = new Activity("ZZZZZZZZZZZZZZZZZZZZZZZY", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testCreateActivity_123456789012345678901234_1() throws Exception {
        Activity activityA = new Activity("123456789012345678901234", "description", 2, 2, 2, 2, 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
    ...
    public void testUpdateActivity_A_0() throws Exception {
        Activity activityA = new Activity("name", "description", 2, 2, 2, 2, 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), 1, 1, null);
        activityA.setProject(project);
        activityA.setMember(member);
        int insertedActivityId = activity_model.insertNewActivity(activityA);
        assertTrue(insertedActivityId != Database.ERROR);
