...
public class Project_controllerTest {
    ...
    public void testCreateProject_A_0() throws Exception {
        Project projectA = new Project("A", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZZZ_0() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZZZ", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_AB_0() throws Exception {
        Project projectA = new Project("AB", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZY_0() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZY", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_PROJECT_0() throws Exception {
        Project projectA = new Project("PROJECT", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_0_0() throws Exception {
        Project projectA = new Project("0", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_1234567890123456789012345_0() throws Exception {
        Project projectA = new Project("1234567890123456789012345", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_01_0() throws Exception {
        Project projectA = new Project("01", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_123456789012345678901234_0() throws Exception {
        Project projectA = new Project("123456789012345678901234", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_125845_0() throws Exception {
        Project projectA = new Project("125845", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_PROJECT125845_0() throws Exception {
        Project projectA = new Project("PROJECT125845", 0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_A_1000000000() throws Exception {
        Project projectA = new Project("A", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("A", projectB.getProjectName());
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZZZ_1000000000() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZZZ", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("ZZZZZZZZZZZZZZZZZZZZZZZZZ", projectB.getProjectName());
    ...
    public void testCreateProject_AB_1000000000() throws Exception {
        Project projectA = new Project("AB", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("AB", projectB.getProjectName());
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZZY_1000000000() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZZY", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_PROJECT_1000000000() throws Exception {
        Project projectA = new Project("PROJECT", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT", projectB.getProjectName());
    ...
    public void testCreateProject_125845_1000000000() throws Exception {
        Project projectA = new Project("125845", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("125845", projectB.getProjectName());
    ...
    public void testCreateProject_PROJECT125845_1000000000() throws Exception {
        Project projectA = new Project("PROJECT125845", 1000000000d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT125845", projectB.getProjectName());
    ...
    public void testCreateProject_PROJECT_1() throws Exception {
        Project projectA = new Project("PROJECT", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT", projectB.getProjectName());
    ...
    public void testCreateProject_125845_1() throws Exception {
        Project projectA = new Project("125845", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("125845", projectB.getProjectName());
    ...
    public void testCreateProject_PROJECT125845_1() throws Exception {
        Project projectA = new Project("PROJECT125845", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT125845", projectB.getProjectName());
    ...
    public void testCreateProject_PROJECT_999999999() throws Exception {
        Project projectA = new Project("PROJECT", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT", projectB.getProjectName());
    ...
    public void testCreateProject_125845_999999999() throws Exception {
        Project projectA = new Project("125845", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("125845", projectB.getProjectName());
    ...
    public void testCreateProject_PROJECT125845_999999999() throws Exception {
        Project projectA = new Project("PROJECT125845", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("PROJECT125845", projectB.getProjectName());
    ...
    public void testCreateProject_AB_1() throws Exception {
        Project projectA = new Project("AB", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("AB", projectB.getProjectName());
    ...
    public void testCreateProject_12_1() throws Exception {
        Project projectA = new Project("12", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZY_999999999() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZY", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("ZZZZZZZZZZZZZZZZZZZZZZZY", projectB.getProjectName());
    ...
    public void testCreateProject_123456789012345678901234_999999999() throws Exception {
        Project projectA = new Project("123456789012345678901234", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("123456789012345678901234", projectB.getProjectName());
    ...
    public void testCreateProject_AB_999999999() throws Exception {
        Project projectA = new Project("AB", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("AB", projectB.getProjectName());
    ...
    public void testCreateProject_12_999999999() throws Exception {
        Project projectA = new Project("12", 999999999d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("12", projectB.getProjectName());
    ...
    public void testCreateProject_ZZZZZZZZZZZZZZZZZZZZZZZY_1() throws Exception {
        Project projectA = new Project("ZZZZZZZZZZZZZZZZZZZZZZZY", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("ZZZZZZZZZZZZZZZZZZZZZZZY", projectB.getProjectName());
    ...
    public void testCreateProject_123456789012345678901234_1() throws Exception {
        Project projectA = new Project("123456789012345678901234", 1d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
        Project projectB = project_model.getProjectById(insertedProjectID);
        assertEquals("123456789012345678901234", projectB.getProjectName());
    ...
    public void testUpdateProject_A_0() throws Exception {
        Project projectA = new Project("name", 0.0d, DateHelper.parse("11/11/2011", Config.DATE_FORMAT_SHORT), DateHelper.parse("11/12/2011", Config.DATE_FORMAT_SHORT), "description");
        int insertedProjectID = project_model.insertNewProject(projectA);
        assertTrue(insertedProjectID != Database.ERROR);
