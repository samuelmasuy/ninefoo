...
public class Member_controllerTest {
    ...
    public void testRegister_success() throws Exception {
        ...
        assertEquals("register is successful message", LanguageText.getConstant("REGISTRATION_SUCCESS"), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_invalid_firstname() throws Exception {
        ...
        assertEquals("register with invalid firstname message", String.format(LanguageText.getConstant("WRONG_FORMAT"), LanguageText.getConstant("FIRST_NAME")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_empty_firstname() throws Exception {
        ...
        assertEquals("register with empty firstname message", String.format(LanguageText.getConstant("REQUIRED"), LanguageText.getConstant("FIRST_NAME")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_invalid_last_name() throws Exception {
        ...
        assertEquals("register with invalid  message", String.format(LanguageText.getConstant("WRONG_FORMAT"), LanguageText.getConstant("LAST_NAME")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_invalid_username() throws Exception {
        ...
        assertEquals("register with invalid username message", String.format(LanguageText.getConstant("WRONG_FORMAT"), LanguageText.getConstant("USERNAME")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_existing_username() throws Exception {
        ...
        assertEquals("register with existing username message", String.format(LanguageText.getConstant("UNIQUE"), LanguageText.getConstant("USERNAME")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_invalid_password() throws Exception {
        ...
        assertEquals("register with invalid password message", String.format(LanguageText.getConstant("WRONG_FORMAT"), LanguageText.getConstant("PASSWORD")), mockUpdatableView.get_message());
    }
    ...
    public void testRegister_long_password() throws Exception {
        ...
        assertEquals("register with too long password message", String.format(LanguageText.getConstant("MAX_LENGTH"), LanguageText.getConstant("PASSWORD"), 10), mockUpdatableView.get_message());
    }
